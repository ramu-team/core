      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center space-y-12">
        ...
        <div className="grid w-full max-w-5xl grid-cols-2 gap-12">
          ...
          <motion.button
            ...
            className="w-full text-left relative flex flex-col overflow-hidden rounded-[3rem] bg-linear-to-b from-stone-900/90 to-stone-900/50 backdrop-blur-3xl border-2 border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.6)] cursor-pointer outline-none focus:outline-none"
          >
            {/* Top Visual Container */}
            <div className="relative w-full h-70 bg-stone-950 shrink-0 overflow-hidden flex items-center justify-center">
            ...
            <div className="flex flex-1 flex-col p-8 pt-6 h-55">
              <div className="mb-4">
              ...
              <div className="mt-auto pt-2 relative">
                ...
                <div className="relative pointer-events-none">
                  <div
                    className="flex items-center justify-center h-20 w-full rounded-full bg-linear-to-r from-amber-400 via-amber-500 to-amber-600 text-[1.4rem] tracking-wide font-extrabold text-stone-950 shadow-[0_5px_20px_rgba(251,191,36,0.3)] border-b-[5px] border-amber-700"
                  >
                    LIHAT DAFTAR
                  </div>
                </div>
